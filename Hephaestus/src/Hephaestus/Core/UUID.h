...
namespace Hep
{
	...
	// used to "uniquely" identify information. In Hephaestus, even though we use the term
...
{
	template <>
	struct hash<Hep::UUID>
	{
		std::size_t operator()(const Hep::UUID& uuid) const noexcept
		{
