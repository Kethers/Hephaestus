...
namespace Hep
{
	...
	void VulkanPipeline::Invalidate()
	{
		...
		Renderer::Submit([instance]() mutable
		{
			...
			HEP_CORE_ASSERT(instance->m_Specification.Shader);
			Ref<VulkanShader> vulkanShader = Ref<VulkanShader>(instance->m_Specification.Shader);
			Ref<VulkanFramebuffer> framebuffer = instance->m_Specification.RenderPass->GetSpecification().TargetFramebuffer.As<
				VulkanFramebuffer>();
