...
namespace Hep
{
	...
	VulkanImage2D::~VulkanImage2D() = default;
	...
	void VulkanImage2D::Release()
	{
		...
		HEP_CORE_WARN("VulkanImage2D::Release ImageView = {0}", (const void*)m_Info.ImageView);
	}
	...
	void VulkanImage2D::UpdateDescriptor()
	{
		...
		HEP_CORE_WARN("VulkanImage2D::UpdateDescriptor to ImageView = {0}", (const void*)m_Info.ImageView);
	}
}
