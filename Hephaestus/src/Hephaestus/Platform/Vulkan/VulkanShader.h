...
namespace Hep
{
	...
	public:
		...
		void SetMat4FromRenderThread(const std::string& name, const glm::mat4& value, bool bind) override;
		...
		{
			HEP_CORE_ASSERT(m_ShaderDescriptorSets.at(set).UniformBuffers.size() > binding);
