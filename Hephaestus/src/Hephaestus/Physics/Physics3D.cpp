...
namespace Hep
{
	...
	static physx::PxFilterFlags HepFilterShader(physx::PxFilterObjectAttributes attributes0, physx::PxFilterData filterData0,
	...
	void Physics3D::Init()
	{
		HEP_CORE_ASSERT(!s_PXFoundation, "PhysXManager::Init shouldn't be called more than once!");

		s_PXFoundation = PxCreateFoundation(PX_PHYSICS_VERSION, s_PXAllocator, s_PXErrorCallback);
		HEP_CORE_ASSERT(s_PXFoundation, "PxCreateFoundation Failed!");
