...
namespace Hep
{
	...
	void SceneHierarchyPanel::DrawComponents(Entity entity)
	{
		...
		if (entity.HasComponent<SpriteRendererComponent>())
		{
			...
			if (ImGui::TreeNodeEx((void*)((uint32_t)entity | typeid(SpriteRendererComponent).hash_code()), ImGuiTreeNodeFlags_DefaultOpen,
				"Sprite Renderer"))
			{
				ImGui::TreePop();
			}
		...
		if (entity.HasComponent<ScriptComponent>())
		{
			...
			if (ImGui::TreeNodeEx((void*)((uint32_t)entity | typeid(ScriptComponent).hash_code()), ImGuiTreeNodeFlags_DefaultOpen,
				"Script"))
			{
				BeginPropertyGrid();
