...
namespace FPSExample
{
	public class FPSPlayer : Entity
	{
		...
		[NonSerialized] public float MouseSensitivity = 10.0F;
		...
		private void UpdateRotation(float ts)
		{
			...
			m_CameraTransform.Rotation =
				new Vector3(Mathf.Clamp(m_CameraTransform.Rotation.X, -80.0F, 80.0F), m_CameraTransform.Rotation.YZ);
		...
		private void UpdateMovement()
		{
			...
			Vector3 movement = m_CameraTransform.Transform.Right * m_MovementDirection.X +
							   m_CameraTransform.Transform.Forward * m_MovementDirection.Y;
			movement.Normalize();
